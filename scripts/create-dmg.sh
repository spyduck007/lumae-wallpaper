...
create-dmg --volname "Lumae" --window-pos 200 120 --window-size 640 420 --icon-size 128 --icon "Lumae.app" 170 190 --hide-extension "Lumae.app" --app-drop-link 470 190 "$OUT" "$APP"
