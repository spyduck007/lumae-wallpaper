...
- Extensible desktop widget overlay system with a refined digital clock and Now Playing card, artwork, animated playback visualization, preset or corner-drag custom sizing, guide snapping, mirrored or per-display layouts, and independent per-monitor visibility.
