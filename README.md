...
- Extensible desktop widget overlay system with a minimal digital clock, optional background, guide snapping, drag-to-position editing, 12/24-hour time, mirrored or per-display layouts, and independent per-monitor visibility.
